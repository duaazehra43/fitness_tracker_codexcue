...
class WorkoutPage extends StatefulWidget {
  ...
  final int index;
  const WorkoutPage(
      {super.key, required this.workoutName, required this.index});
...
// create a new exercise
  ...
  bool checkWorkoutDetailsIfEmpty(
...
//delete exercise
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          MaterialButton(
            onPressed: () {
              saveExistingExercise(indexOfWorkout, indexOfExercise,
                  oldExerciseName, oldWeight, oldReps, oldSets);
            },
            child: const Text("save"),
          ),
          // cancel button
  ...
  void saveExistingExercise(
    ...
    saveExistingExerciseAfterResetAllParameters(
        indexOfWorkout, indexOfExercise, newExerciseName, weight, reps, sets);
  }

  void saveExistingExerciseAfterResetAllParameters(
      int indexOfWorkout,
      int indexOfExercise,
        ...
        body: Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) => ExerciseTile(
              ...
              weight: value.workoutList[widget.index].exercises[index].weight,
              //get reps of this exercise in a specific workout
              reps: value.workoutList[widget.index].exercises[index].reps,
              //get sets of this exercise in a specific workout
              sets: value.workoutList[widget.index].exercises[index].sets,
              //get check if isCompleted is true or flase of this exercise in a specific workout
              isCompleted:
                  value.workoutList[widget.index].exercises[index].isCompleted,
              ...
              settingsTapped: (context) => updateExercise(
                widget.index,
                index,
                value.workoutList[widget.index].exercises[index].name,
                value
                    //get a name of exercise in a specific workout
                    .workoutList[widget.index]
                    .exercises[index]
