import 'package:fitness/date_time.dart';
import 'package:fitness/exercise_model.dart';
import 'package:fitness/hive_database.dart';
import 'package:fitness/workout_model.dart';
...
class WorkoutData extends ChangeNotifier {
  ...
  */
  ...
  void addExercise(int indexOfWorkout, String exerciseName, String weight,
  ...
  void checkOfExercise(int indexOfWorkout, int indexOfExercise) {
    ...
    Exercise relevantExercise =
        workoutList[indexOfWorkout].exercises[indexOfExercise];
